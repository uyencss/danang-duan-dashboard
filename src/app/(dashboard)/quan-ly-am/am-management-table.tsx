                ...
                <Table className="min-w-[1700px]">
                    <TableHeader className="bg-slate-50/50">
                        <TableRow className="border-b border-slate-100">
                             ...
                             <TableHead className="font-black text-slate-500 uppercase tracking-widest text-[10px]">Account Manager</TableHead>
                    ...
                    <TableBody>
                        {data.map((am, idx) => (
                            <TableRow key={am.id} className="group hover:bg-slate-50/80 transition-all border-b border-slate-50">
