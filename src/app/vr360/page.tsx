  ...
  const gemData = [
    {
      ...
      tagline: '"Người giữ thành phố — và những điều họ chưa bao giờ kể công"',
      texts: [
        <>Bạn đã đi qua trụ sở Công an trên đường Lê Lợi bao nhiêu lần mà không biết bên trong có một căn phòng lưu giữ hơn <strong>80 năm lịch sử bảo vệ Đà Nẵng</strong>?</>,
    ...
    },
    {
      ...
      tagline: '"Vùng đất 1.000 năm tuổi ngay giữa lòng Đà Nẵng — bị lãng quên vì quá gần"',
      texts: [
        ...
        <>Di tích <strong>duy nhất trong toàn hệ thống tháp Chăm</strong> có thể nghiên cứu nền móng và hố thiêng — thứ Mỹ Sơn không có.</>,
      ],
    ...
    },
    {
      ...
      texts: [
        <>Bạn đã thấy đủ ảnh đèn lồng Hội An chưa? Góc nhìn này khác hoàn toàn.</>,
        <>Nằm ven <strong>sông Thu Bồn huyền thoại</strong>, The Pearl Hội An là khoảng lặng sang trọng cách xa đám đông phố cổ — nơi mặt nước phản chiếu bầu trời: <strong>thật sự bình yên.</strong></>,
        <>Xem VR360 trước để hiểu tại sao du khách quay lại Hội An lần thứ hai, lần thứ ba — nhưng theo <strong>một cách hoàn toàn khác.</strong></>,
      ],
    ...
    },
    {
      ...
      tagline: '"Ngôi làng đã chiến đấu để bạn có mùa hè này"',
      texts: [
    ...
    },
    {
      ...
      tagline: '"Thiên hạ đệ nhất hùng quan — và bạn chưa thật sự đứng ở đó"',
      texts: [
        <>Hàng triệu người <strong>chui qua hầm Hải Vân</strong> mỗi năm. Rất ít biết ở độ cao gần 500m phía trên là một trong những di tích lịch sử hùng vĩ nhất Việt Nam.</>,
        ...
        <><strong>Di tích Quốc gia</strong> từ 2017. Được xếp hạng — nhưng vẫn bị bỏ qua. Bạn sắp là ngoại lệ.</>,
      ],
      ...
      <footer>
        <div className="footer-inner">
          ...
          <div className="footer-links">
            <a href="https://danang.mobifone.vn" target="_blank" rel="noopener noreferrer">Trang chính</a>
